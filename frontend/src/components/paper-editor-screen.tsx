...
export function PaperEditorScreen({ paperId }: { paperId: string }) {
  ...
  }, [paper?.id, paper?.branding_template_id, paper?.branding_config, brandingTemplates]);
