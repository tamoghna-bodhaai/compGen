...
Transcribe faithfully. Do not invent missing symbols, options, answers, solutions, topics, or question boundaries. Classify each real question into JEE or NEET, the requested subject taxonomy, chapter, topic, optional subtopic, a supported type, and difficulty. Use `null` for unknown optional fields. Include an answer or worked solution only when it is explicitly present in the source. Use empty options for numerical or subjective questions."""
