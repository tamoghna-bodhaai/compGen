...
\fancyfoot[C]{\footnotesize Learning made clear  $\cdot$  Page \thepage}
\renewcommand{\headrulewidth}{0.4pt}
\begin{document}
{\centering \large \textbf{ThinkC}\par}
{\centering \footnotesize Kolkata, West Bengal\par}
\vspace{2mm}
...
\noindent\rule{\linewidth}{1.1pt}\vspace{-1mm}\noindent\rule{\linewidth}{0.5pt}
\vspace{1mm}
\noindent \textbf{Duration:} 3 : 00 hours \quad \textbf{Total Marks:} 100 \quad \textbf{Questions:} 25\par
\vspace{2mm}
