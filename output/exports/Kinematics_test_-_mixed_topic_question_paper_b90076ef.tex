...
\begin{document}
\vspace{2mm}
\noindent \textbf{Marks : 138} \hfill \textbf{Time : 2 : 30 hours}
...
\noindent\rule{\linewidth}{1.1pt}\vspace{-1mm}\noindent\rule{\linewidth}{0.5pt}
\vspace{1mm}
\noindent \textbf{Duration:} Not specified \quad \textbf{Total Marks:} 138 \quad \textbf{Questions:} 40\par
\vspace{2mm}
